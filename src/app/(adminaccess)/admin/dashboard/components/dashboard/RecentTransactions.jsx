...
var RecentTransactions = function () {
    var _a;
    return (<DashboardCard title="Recent Transactions">
      <>
        <Timeline className="theme-timeline" nonce={undefined} onResize={undefined} onResizeCapture={undefined} sx={_a = {
                p: 0,
                mb: '-40px',
            ...
            _a["& .".concat(timelineOppositeContentClasses.root)] = {
                flex: 0.5,
                paddingLeft: 0,
            },
            _a}>
