...
var DailyActivity = function () {
    return (<DashboardCard title="Daily Activity">
      <Timeline sx={{
            p: 0,
        }}>
        {activities.map(function (activity) { return (<TimelineItem key={activity.time}>
            ...
            <TimelineContent color="text.secondary" sx={{
                fontSize: "14px",
            }}>
              {activity.text}
            </TimelineContent>
