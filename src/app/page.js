...
<div className="xl:w-1/3 md:w-1/2 p-4">
  <Link href={'/tshirts'}>
    <div className="border border-gray-200 p-6 rounded-lg shadow-lg cursor-pointer">
    <div className="w-15 h-15 inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-500 mb-4">
